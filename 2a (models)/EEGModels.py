...
def EEGNet_fusion(nb_classes, Chans=25, Samples=500,
...
def EEGNet(nb_classes, Chans=25, Samples=500,
...
def DeepConvNet(nb_classes, Chans=25, Samples=500,
...
def ShallowConvNet(nb_classes, Chans=25, Samples=500, dropoutRate=0.5, cpu=False):
    if cpu:
        input_shape = (Samples, Chans, 1)
        conv_filters = (25, 1)
        conv_filters2 = (1, Chans)
